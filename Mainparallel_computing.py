# -*- coding: utf-8 -*-
"""
Created on Fri Jul  7 03:12:11 2023
...
pool = ThreadPool()
x1 = range(0, 5)  # random seed
T = [100, 200, 500]  # length of the experiment
K = [1, 2, 3, 4, 5]  # the parallel machine
name = ("FIFO", "SPT", "EDD")  # the dispatching rules
limit = ([1, 100], [51, 150], [101, 200])
args = product(x1, T, K, name, limit)
pool.imap(simulation, args)
pool.close()
pool.join()
